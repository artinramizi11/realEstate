...
import '../DisplaySingleProperty/SingleProperty.css'
  ...
  return (
       ...
       <Nav display='singleproperty' />
        <div className='container'>
          <div className="left-side" style={{display: 'flex', flexDirection: 'column', gap: '10px'}}>
        ...
        <Location />
          ...
          <div className="right-side" style={{display: 'flex', flexDirection: 'column', gap: '10px'}}>
            <AgentInformation />
            <RecentProperties />
            <Offer/>
            <PopularTags />
